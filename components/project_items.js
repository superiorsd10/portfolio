...
export const projectItems = [
    {
        ...
        header: <img src="/images/eduhub-ai.webp" className="rounded-sm"></img>,
    ...
    },
    {
        ...
        header: <img src="/images/ultimate-alarm-clock.webp" className="rounded-sm"></img>,
        className: "md:col-span-1",
    ...
    },
    {
        ...
        header: <img src="/images/confess.webp" className="rounded-sm"></img>,
        className: "md:col-span-1",
    ...
    },
    {
        ...
        header: <img src="/images/dash-ai.webp" className="rounded-sm"></img>,
        className: "md:col-span-1",
    ...
    },
    {
        ...
        header: <img src="/images/snake-bit.webp" className="rounded-sm"></img>,
        className: "md:col-span-1",
    ...
    },
    {
        ...
        header: <img src="/images/mirai.webp" className="rounded-sm"></img>,
        className: "md:col-span-1",
    ...
    },
    {
        ...
        header: <img src="/images/college-gatekeeper.webp" className="rounded-sm"></img>,
        className: "md:col-span-1",
    ...
    },
    {
        ...
        header: <img src="/images/block-todo.webp" className="rounded-sm"></img>,
        className: "md:col-span-1",
    ...
    },
    {
        ...
        header: <img src="/images/agrico.webp" className="rounded-sm"></img>,
        className: "md:col-span-1",
