...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[100vh] md:min-h-[200vh]  flex flex-col items-center py-0 md:py-0 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.45] sm:scale-50"
    >
      <motion.h2
        style={{
        ...
        className="dark:text-white text-neutral-800 text-[26px] sm:text-3xl font-bold mb-20 text-center"
      >
        {title || (
          <span>
